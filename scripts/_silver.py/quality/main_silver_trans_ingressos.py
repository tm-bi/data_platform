...
HEADER_PREFIX = "idContasAReceber;idIngresso;ingresso_numero;"
...
def normalize_columns(df: pd.DataFrame) -> pd.DataFrame:
    rename_map = {
        ...
        "ingresso_numero": "num_ingresso",
        "dataUtilizacao": "dt_utilizacao",
        ...
        "cpfCnpj": "cpf",
        "tipoRelacionamentoEmpresa": "tipo_relac_empresa",
        "tipoMovimento": "tipo_movimento",
        "tipoOperacao": "tipo_operacao",
        "cartaoMovimento": "cartao_movimento",
...
def cast_types(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for col in ("dt_utilizacao", "dt_inicio", "dt_fim", "dt_cancelamento", "dt_venda"):
        ...
        conn.execute(
            text(
                ...
                CREATE TABLE IF NOT EXISTS "{schema}"."{table}" (                  
                    ...
                    cliente TEXT,
                    cpf TEXT,
                    tipo_relac_empresa TEXT,
                    vendedor TEXT,
                    tipo_movimento TEXT,
                    tipo_operacao TEXT,
                    cartao_movimento TEXT,
...
def main() -> None:
    ...
    bronze_table = os.getenv("SRC_TABLE_INGRESSOS")
    silver_table = os.getenv("SILVER_TABLE_INGRESSOS")
